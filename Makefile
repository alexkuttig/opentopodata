...
run:
	docker run --rm -it --volume /mnt/data/opentopodata:/app/data:ro -p 5000:5000 opentopodata:$(VERSION)

daemon:
	docker run --rm -itd --volume /mnt/data/opentopodata:/app/data:ro -p 5000:5000 opentopodata:$(VERSION)
